  ...
  head: () => ({
    meta: [
      { title: "KairoID — Trust for institutions and the people they educate" },
      {
        name: "description",
        content:
          "KairoID helps universities, colleges and training institutes issue, verify and protect educational trust.",
      },
      {
        property: "og:title",
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-white to-[color:var(--kairo-teal-soft)]">
      <div className="mx-auto flex min-h-screen max-w-3xl flex-col items-center justify-center gap-6 px-6 py-12 text-center">
        ...
        <p className="max-w-xl text-sm text-muted-foreground">
          KairoID gives universities, colleges, schools, and training institutes a focused workspace
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          ...
          >
            <ShieldCheck className="h-4 w-4" /> Explore KairoID for Institutions
          </Link>
